...
# load dataset
dataset_raw = read_csv("C:/Users/Ben Bowes/Documents/HRSD GIS/Site Data/MMPS_170_no_blanks.csv",
...
# model = keras.models.load_model("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/keras_models/mmps170.h5",
...
# save model
# model.save("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/keras_models/mmps170.h5")
...
inv_yhat_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps170_results/predicted.csv")
inv_y_df = DataFrame(inv_y)
inv_y_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps170_results/observed.csv")
...
RMSE_forecast.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps170_results/RMSE.csv")
...
dates_18 = dates_18[5600:]
dates_18 = dates_18.reset_index(inplace=False)
dates_18 = dates_18.drop(columns=['index'])
fig, (ax1, ax2, ax3) = plt.subplots(1, 3, sharey=True, figsize=(6.5, 3))
x_ticks = np.arange(0, 1681, 168)
ax1.plot(inv_y[5600:, 0], 'k-', label='Obs.')
ax1.plot(inv_yhat[5600:, 0], 'k:', label='Pred.')
ax1.set_xticks(x_ticks)
ax1.set_xticklabels(dates['Datetime'][x_ticks].dt.strftime('%Y-%m-%d'), rotation='vertical')
ax2.plot(inv_y[5600:, 8], 'k-', label='Obs.')
ax2.plot(inv_yhat[5600:, 8], 'k:', label='Pred.')
ax2.set_xticks(x_ticks)
ax2.set_xticklabels(dates_9['Datetime'][x_ticks].dt.strftime('%Y-%m-%d'), rotation='vertical')
ax3.plot(inv_y[5600:, 17], 'k-', label='Obs.')
ax3.plot(inv_yhat[5600:, 17], 'k:', label='Pred.')
...
plt.tight_layout()
plt.show()
# fig.savefig('C:/Users/Ben Bowes/Documents/HRSD GIS/Presentation Images/Paper Figures/MMPS170_preds.tif', dpi=300)

# create dfs of timestamps, obs, and pred data to find peak values and times
obs_t1 = np.reshape(inv_y[5600:, 0], (1633, 1))
pred_t1 = np.reshape(inv_yhat[5600:, 0], (1633,1))
...
obs_t9 = np.reshape(inv_y[5600:, 8], (1633, 1))
pred_t9 = np.reshape(inv_yhat[5600:, 8], (1633,1))
...
obs_t18 = np.reshape(inv_y[5600:, 17], (1633, 1))
pred_t18 = np.reshape(inv_yhat[5600:, 17], (1633,1))
...
JuliaPeak_t1 = df_t1.loc["2016-09-18T00:00:00.000000000":"2016-09-27T00:00:00.000000000"].max()
JuliaPeak_t1_time = df_t1.loc["2016-09-18T00:00:00.000000000":"2016-09-27T00:00:00.000000000"].idxmax()
...
JuliaPeak_t9 = df_t9.loc["2016-09-18T00:00:00.000000000":"2016-09-27T00:00:00.000000000"].max()
JuliaPeak_t9_time = df_t9.loc["2016-09-18T00:00:00.000000000":"2016-09-27T00:00:00.000000000"].idxmax()
...
JuliaPeak_t18 = df_t18.loc["2016-09-18T00:00:00.000000000":"2016-09-27T00:00:00.000000000"].max()
JuliaPeak_t18_time = df_t18.loc["2016-09-18T00:00:00.000000000":"2016-09-27T00:00:00.000000000"].idxmax()
...
peaks_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps170_results/peaks.csv")

# plot all test predictions
plt.plot(inv_y[5600:, 0], label='actual')
plt.plot(inv_yhat[5600:, 0], label='predicted')
plt.xlabel("Timestep")
plt.ylabel("GWL (ft)")
...
NSE_forecast_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps170_results/NSE.csv")
