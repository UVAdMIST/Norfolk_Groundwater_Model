...
values of gwl for well MMPS-129
"""
...
# load dataset
dataset_raw = read_csv("C:/Users/Ben Bowes/Documents/HRSD GIS/Site Data/MMPS_129_no_blanks.csv",
...
# model = keras.models.load_model("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/keras_models/mmps129.h5",
...
# save model
# model.save("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/keras_models/mmps129.h5")
...
inv_trainPredict_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps129_results/train_predicted.csv")
inv_train_y_df = DataFrame(inv_train_y)
inv_train_y_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps129_results/train_observed.csv")

# save test predictions and observed
inv_yhat_df = DataFrame(inv_yhat)
inv_yhat_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps129_results/predicted.csv")
inv_y_df = DataFrame(inv_y)
inv_y_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps129_results/observed.csv")
...
RMSE_forecast.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps129_results/RMSE.csv")
...
ax1.text(-200, 12, 't+1')
ax2.text(-200, 12, 't+9')
ax3.text(-200, 12, 't+18')
ax2.set(ylabel="GWL (ft)")
plt.legend(loc=9)
plt.tight_layout()
plt.show()
fig.savefig('C:/Users/Ben Bowes/Documents/HRSD GIS/Presentation Images/Paper Figures/MMPS129_preds.tif', dpi=300)

# create dfs of timestamps, obs, and pred data to find peak values and times
obs_t1 = np.reshape(inv_y[:, 0], (8372, 1))
pred_t1 = np.reshape(inv_yhat[:, 0], (8372,1))
...
obs_t9 = np.reshape(inv_y[:, 8], (8372, 1))
pred_t9 = np.reshape(inv_yhat[:, 8], (8372,1))
...
obs_t18 = np.reshape(inv_y[:, 17], (8372, 1))
pred_t18 = np.reshape(inv_yhat[:, 17], (8372,1))
...
peaks_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps129_results/peaks.csv")

# plot all test predictions
plt.plot(inv_y[5000:5200, 17], label='actual')
plt.plot(inv_yhat[5000:5200,17], label='predicted')
plt.xlabel("Timestep")
plt.ylabel("GWL (ft)")
...
JuliaStart, JuliaStop = "2016-09-18 00:00:00", "2016-09-27 00:00:00"
MatthewStart, MatthewStop = "2016-10-07 00:00:00", "2016-10-14 00:00:00"
...
ax = Matthew[["Tide", "GWL", "Pred. GWL t+18"]].plot(color=["k"], style=[":", '-', '-.'], legend=None)
...
ax2.invert_yaxis()
Matthew["Precip."].plot.bar(ax=ax2, color="k")
ax2.set_xticks([])
ax.set_xticks(ticks)
ax.set_xticklabels(Matthew.loc[ticks, 'Datetime'].dt.strftime('%Y-%m-%d'), rotation='vertical')
...
# plt.savefig('C:/Users/Ben Bowes/Documents/HRSD GIS/Presentation Images/Paper Figures/MMPS129_preds_allvars.tif', dpi=300)
...
NSE_forecast_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps129_results/NSE.csv")
