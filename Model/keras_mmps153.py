...
# load dataset
dataset_raw = read_csv("C:/Users/Ben Bowes/Documents/HRSD GIS/Site Data/MMPS_153_no_blanks.csv",
...
# model = keras.models.load_model("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/keras_models/mmps153.h5",
...
inv_yhat_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps153_results/predicted.csv")
inv_y_df = DataFrame(inv_y)
inv_y_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps153_results/observed.csv")
...
RMSE_forecast.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps153_results/RMSE.csv")
...
plt.tight_layout()
plt.show()
# fig.savefig('C:/Users/Ben Bowes/Documents/HRSD GIS/Presentation Images/Paper Figures/MMPS153_preds.tif', dpi=300)

# create dfs of timestamps, obs, and pred data to find peak values and times
obs_t1 = np.reshape(inv_y[5700:8000, 0], (2287, 1))
pred_t1 = np.reshape(inv_yhat[5700:8000, 0], (2287,1))
...
obs_t9 = np.reshape(inv_y[5700:8000, 8], (2287, 1))
pred_t9 = np.reshape(inv_yhat[5700:8000, 8], (2287,1))
...
obs_t18 = np.reshape(inv_y[5700:8000, 17], (2287, 1))
pred_t18 = np.reshape(inv_yhat[5700:8000, 17], (2287,1))
...
peaks_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps153_results/peaks.csv")
...
NSE_forecast_df.to_csv("C:/Users/Ben Bowes/PycharmProjects/Tensorflow/mmps153_results/NSE.csv")
