%%data prep
data_file = csvread('C:/Users/Ben Bowes/Documents/HRSD GIS/Site Data/MMPS_155_no_blanks.csv', 1,1);
HRRR_data = csvread('C:/HRRR/HRRR_Archive_20160802_hr_20/rainfall.csv', 1,1);
SewellsPt_data = csvread('C:/Users/Ben Bowes/Documents/HRSD GIS/Tide_hr_Sewells_Pt/Tide_20160802_hr16.csv', 1,1);

gwl = data_file(:,1);
tide = data_file(:,2);
precip = data_file(:,5);
forecast_precip = HRRR_data(:,3);
