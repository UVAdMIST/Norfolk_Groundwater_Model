...
values of gwl for well MMPS-125
"""
...
full_dataset = read_csv("/scratch/bdb3m/mmps125_bootstraps/bs0.csv", usecols=["Datetime", 'GWL', 'Tide', 'Precip.'])
# dataset.loc[dataset['GWL'] > 1.24, 'GWL'] = 1.24
