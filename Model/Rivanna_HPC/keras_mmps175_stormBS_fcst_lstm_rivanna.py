...
This network uses the last 58 observations of gwl, tide, and rain to predict the next 18
...
full_data = pd.read_csv("/scratch/bdb3m/mmps175_bootstraps/bs0.csv", usecols=["Datetime", 'GWL', 'Tide', 'Precip.'])

# load forecast test data
fcst_data = pd.read_csv("/scratch/bdb3m/MMPS175_fcstdata_SI.csv")
...
inv_yhat[inv_yhat > 2.57] = 2.57
inv_fcst_yhat[inv_fcst_yhat > 2.57] = 2.57
