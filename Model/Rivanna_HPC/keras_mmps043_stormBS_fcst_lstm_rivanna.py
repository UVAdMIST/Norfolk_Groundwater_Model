...
full_data = pd.read_csv("/scratch/bdb3m/mmps043_bootstraps/bs0.csv", usecols=["Datetime", 'GWL', 'Tide', 'Precip.'])

# load forecast test data
fcst_data = pd.read_csv("/scratch/bdb3m/MMPS043_fcstdata_SI.csv")
# fcst_data = pd.read_csv("C:/Users/Ben Bowes/Documents/HRSD GIS/Site Data/Forecast_data/MMPS_043testdata_SI.csv")
