...
full_data = pd.read_csv("/scratch/bdb3m/mmps155_bootstraps/bs0.csv", usecols=["Datetime", 'GWL', 'Tide', 'Precip.'])

# load forecast test data
fcst_data = pd.read_csv("/scratch/bdb3m/MMPS155_fcstdata_SI.csv")
...
inv_yhat[inv_yhat > 1.72] = 1.72
inv_fcst_yhat[inv_fcst_yhat > 1.72] = 1.72
