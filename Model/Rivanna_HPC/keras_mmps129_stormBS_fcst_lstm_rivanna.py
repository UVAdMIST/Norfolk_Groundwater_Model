...
This network uses the last 59 observations of gwl, tide, and rain to predict the next 18
...
full_data = pd.read_csv("/scratch/bdb3m/mmps129_bootstraps/bs0.csv", usecols=["Datetime", 'GWL', 'Tide', 'Precip.'])

# load forecast test data
fcst_data = pd.read_csv("/scratch/bdb3m/MMPS129_fcstdata_SI.csv")
...
inv_yhat[inv_yhat > 4.35] = 4.35
inv_fcst_yhat[inv_fcst_yhat > 4.35] = 4.35
